...
const HeaderDisplay = () => {
    const imagesData=["https://images.pexels.com/photos/163117/keyboard-white-computer-keyboard-desktop-163117.jpeg?auto=compress&cs=tinysrgb&w=600"
 ...
 <CarouselItem key={image}>
    <img src={image} loading='lazy' className="object-cover w-full h-[60vh] rounded-3xl" alt="" />
 </CarouselItem>
        ))
    }
